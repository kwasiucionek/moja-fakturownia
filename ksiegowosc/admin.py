...
class InvoiceAdmin(admin.ModelAdmin):
    ...
    exclude = ("user",)
    actions = ["export_selected_to_jpk", "send_to_ksef", "check_ksef_status"]
    ...
    def generate_pdf_view(self, request, object_id):
        from weasyprint import HTML  # Import przeniesiony do metody
...
# ... (Reszta pliku od MonthlySettlementAdmin do końca) ...
...
class MonthlySettlementAdmin(admin.ModelAdmin):
    ...
    def parse_jpk_ewp_file(self, xml_file, user):
        try:
            ...
            for (year, month), total_revenue in monthly_revenues.items():
                _, created = MonthlySettlement.objects.update_or_create(
                    user=user,
                    year=year,
                    month=month,
                    defaults={
    ...
    def dashboard_view(self, request):
        # Implementacja dashboard_view...
        return render(request, "admin/enhanced_dashboard.html", {})

    def calculate_view(self, request):
        # Implementacja calculate_view...
        return render(request, "ksiegowosc/settlement_form.html", {})

    def zus_calculator_view(self, request):
        # Implementacja zus_calculator_view...
        return render(request, "ksiegowosc/zus_calculator.html", {})
...
class YearlySettlementAdmin(admin.ModelAdmin):
    ...
    def calculate_yearly_view(self, request):
        # Implementacja calculate_yearly_view...
        return render(request, "ksiegowosc/yearly_settlement_form.html", {})

    def generate_yearly_pdf_view(self, request, object_id):
        from weasyprint import HTML  # Import przeniesiony do metody

        # Implementacja generowania PDF...
        return HttpResponse("PDF w trakcie implementacji", content_type="text/plain")

    def view_yearly_settlement(self, request, object_id):
        # Implementacja view_yearly_settlement...
        return render(request, "ksiegowosc/yearly_settlement_view.html", {})
